 ...
 */
@RestController
@RequestMapping("/api/sys/prescription")
@Api(tags = "PrescriptionController", description = "处方")
public class PrescriptionController {
	...
	public Map addPrescription(String params) {
		Prescription prescription = null;
		try {
			prescription = (Prescription) JsonUtil.jsonToJava(params, Prescription.class.getName());
		} catch (Exception e) {
