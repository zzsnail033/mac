 ...
 */
@RestController
@RequestMapping("/api/sys/doctor-basic-info")
@Slf4j
@Api(tags = "DoctorBasicInfoController", description = "医师药师信息表")
public class DoctorBasicInfoController {

	@PostMapping(value = "/addDoctorBasicInfo")
	@ApiResponses(value = {
	...
	public Map addDoctorBasicInfo(String params) {
		DoctorBasicInfo doctorBasicInfo = null;
		try {
			doctorBasicInfo = (DoctorBasicInfo) JsonUtil.jsonToJava(params, DoctorBasicInfo.class.getName());
		} catch (Exception e) {
